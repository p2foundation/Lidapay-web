...
import { ArrowLeft, Phone, CheckCircle, XCircle, Clock, Copy, Share2 } from "lucide-react";
import { useState } from "react";

export default function AirtimeTransactionDetailPage() {
  ...
  // In a real app, you'd have a getTransactionById endpoint
  const { data, isLoading } = useQuery({
    queryKey: ["airtime-transaction-detail", transactionId],
    queryFn: async () => {
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-500 dark:text-zinc-400">
                      {toText(transaction.transType) || "GLOBAL AIRTIME"}
                    </p>
                  </div>
                </div>
